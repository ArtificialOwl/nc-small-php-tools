...
namespace daita\NcSmallPhpTools\DI;


use Closure;
use daita\NcSmallPhpTools\Exceptions\DependencyInjectionException;
 ...
 *
 * @package daita\NcSmallPhpTools\DI
 */
class DIContainer extends Container {
	 ...
	 * @param bool $shared
	 */
	public function registerInterface(string $interface, string $service, bool $shared = true): void {
		$this->registerClass(
	 ...
	 * @param bool $shared
	 */
	public function registerClass(string $name, Closure $closure, bool $shared = true): void {
		if ($shared) {
			$this[$name] = $closure;
		} else {
